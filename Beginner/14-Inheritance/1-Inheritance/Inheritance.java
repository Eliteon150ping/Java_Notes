...
public class  Inheritance {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(car.doors);        // Print the attributes from the 'car' class.
                                              /* NB: The 'bicycle()' method from the 'bike' class will NOT work for the
                                                     'car' class.                                                     */

        System.out.println(bike.pedals);      // Print the attributes from the 'bike' class.
                                              /* NB: The 'doors()' method from the 'car' class will NOT work for the
                                                    'bike' class.                                                     */

...
If an abstract class contains abstract methods, any concrete subclass (a non-abstract class) must override and provide
implementations for ALL the abstract methods.
However, if a subclass is also declared abstract, it is not required to implement the abstract methods from the parent
class.

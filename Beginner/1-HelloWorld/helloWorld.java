package helloWorld;
             ...
             // Case-sensitive(Use camel-case for naming with more than 1 word.)
...
*  2) javac helloWorld.java (Called compiling).
*  3) Again type java helloWorld(.java) to see the output. */

// Compiling Java code is essential because the machine(Your PC) cannot understand a human-readable language like Java.
// By translating human-readable code into machine-readable language, the Java compiler ensures that the code runs and produces the expected output.
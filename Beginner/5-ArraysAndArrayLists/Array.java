...
public class Array {
    ...
    public static void main(String[] args) {
        ...
        int[] ages = new int[3];                          // This approach creates the array with 3 indexes but does not have values which has to be manually inputted.
        ages[0] = 19;                                     // The starting index of an array ALWAYS starts from 0.
        ages[1] = 42;
        ages[2] = 92;
        ages[0] = 20;                                     // This will update the value from 19 to 20 at that index position.
        ...
        // An enhanced for loop to print out all values of an array without the use of 'import java.util.Arrays;' and 'Arrays.toString(arrayName)'

        for (int age : ages ) {                  // for (type tempoVariable : arrayName){
            System.out.println(age);             //  System.out.println(tempoVariable);
        }                                        // }

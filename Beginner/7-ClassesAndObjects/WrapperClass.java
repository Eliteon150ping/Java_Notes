...
public class WrapperClass {
    public static void main(String[] args) {
        ...
        // 1) '.toString()' Method              // Allows any primitive data type to be converted to a String
        String a2 = Integer.toString(123);
        String b2 = Double.toString(3.14);
        String c2 = Character.toString('$');
        String d2 = Boolean.toString(true);

        String x = a2 + b2 + c2 + d2;           // Here we're able to convert all of the data types into a String which
        System.out.println(x);                  // can be concated into one big String

        // 2) '.Parse...' Method()              // Converts a String into a primitive data type
        int a3 = Integer.parseInt("123");
        double b3 = Double.parseDouble("3.14");
        char c3 = ("Pizza").charAt(0);                // .charAt() is used for accessing a index position of a String
                                                      // and converting that character into a Char.
        boolean d3 = Boolean.parseBoolean("true");

        // 3) Checking types                   // Returns true or false, good for validating user input
        char letter = 'a';
        System.out.println(Character.isLetter(letter));
        System.out.println(Character.isUpperCase(letter));

        // 4) '.valueOf()' method                     // Converts a String into a Wrapper Object instead of a Primitive.
        ...
        // 5) ...Value() -> converts wrapper object back to primitive(alternative way)

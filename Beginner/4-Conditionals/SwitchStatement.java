    ...
    public static void main(String[] args) {
        ...
        switch (month) {
            ...
            case 12:
                ...
                break;                                       // The 'break' keyword is important here since it cancels
                                                             // the operation and does not execute the other outputs if
...
NB: The 'default' case is not always needed nor has to be always below the all of the other cases but it's good practise
to do so

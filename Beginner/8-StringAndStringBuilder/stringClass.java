...
public class stringClass {
    ...
    public static void main(String[] args) {
        ...
        // The .length method can be useful to return a number and compare it to something else to get a desired output
        // eg:
        if(stringLength == 11){ // Since "Hello World" is 11 characters(including the spaces), we get "good" since the
                                // condition is true.
        ...
        String greet = " HOW ".trim();                                                     // ".trim()" will remove any
                                                                                           // blank spaces ONLY before
                                                                                           // and after a word/sentence,
                                                                                           // not in between.

        String lc = greet + "DY".toLowerCase();                                            // ".toLowerCase()" will
                                                                                           // convert any upper case
                                                                                           // letters to lower case.
                                                                                           // The "toUpperCase()" will
                                                                                           // do the opposite.
                  // Or
        ...
        int idx2 = phoneNum.indexOf('-', idx1+1);                           // If you put any number after
                                                                                        // 1 in the 2nd argument of
                                                                                        // "idx1+1", you'll still get 7.
